...
import Host_Card from "../../features/HostCard/Host_Card";
import {
  BusinessName,
  Description,
  Location,
...
const steps = [
  { component: BusinessName, name: "Business Name", field: "name" },
  { component: Description, name: "Description", field: "description" },
  { component: PhoneField, name: "Phone Number", field: "phone" },
  { component: EmailField, name: "Email Address", field: "email" },
  { component: Location, name: "Location", field: "coordinates" },
  { component: Policies, name: "Policies", field: "policies.cancellation" },
];

const HostFormWizard = ({ onSubmit, isLoading, error }) => {
  ...
  return (
    ...
    >
      {/* Centered Home Button with Animation */}
